// Write a C program to implement the C-SCAN Disk Schedulingalgorithm to calculate the total seek count. The program should prompt the user to enter the size of the disk queue, the disk queue itself, the last position of the queue, and the initial head position.
